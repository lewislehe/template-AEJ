% based on AEJ-Article.tex for AEA last revised 22 June 2011
\documentclass[AEJ,
...
References here (manual or bibTeX). If you are using bibTeX, add your bib file name in place of BibFile in the bibliography command.
